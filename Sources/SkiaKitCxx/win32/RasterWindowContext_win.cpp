...
using SC::RasterWindowContext;
using SC::DisplayParams;
...
void RasterWindowContext_win::resize(int w, int h) {
    ...
    auto alphaType = kPremul_SkAlphaType;
    // alphaType = kUnpremul_SkAlphaType;
    SkImageInfo info = SkImageInfo::Make(w, h, fDisplayParams.fColorType, alphaType,
